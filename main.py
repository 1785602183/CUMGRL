...
def parse_args():
    ...
    parser.add_argument('--embedder', nargs='?', default='DMGI3')
    ...
    parser.add_argument('--l2_coef', type=float, default=0.0005)
...
def main():
    ...
    if args.embedder == 'CUMGRL':
        from models import CUMGRL
        embedder = CUMGRL(args)
